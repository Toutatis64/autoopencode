# Autocode — Autonomous Code Improvement Engine

Autocode is a drop-in autonomous improvement loop for any repository.
...
5. **Share improvements**: PR to the autocode repo benefits all teams
