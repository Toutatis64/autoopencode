...
PRESETS: dict[str, dict[str, Any]] = {
    "python": {
        ...
        "modules": [
            ...
            {"name": "scripts", "description": "Utility scripts and tools", "keywords": ["script", "cli", "tool", "bin"]},
            {"name": "docs", "description": "Documentation", "keywords": ["doc", "readme", "guide", "md"]},
            {"name": "data", "description": "Data files, configs, migrations", "keywords": ["data", "config", "migration", "schema"]},
            {"name": "ci_cd", "description": "CI/CD pipelines and infra config", "keywords": ["ci", "cd", "docker", "deploy", "action"]},
        ],
    },
    "node_ts": {
        "validation": {
        ...
        "modules": [
            {"name": "api", "description": "API endpoints and middleware", "keywords": ["api", "route", "endpoint", "controller", "middleware"]},
            {"name": "web", "description": "Web UI components and pages", "keywords": ["component", "page", "ui", "hook", "view"]},
            {"name": "shared", "description": "Shared types, utilities, contracts", "keywords": ["shared", "common", "util", "type", "dto"]},
            {"name": "database", "description": "Database schemas and queries", "keywords": ["database", "migration", "schema", "model", "query"]},
            {"name": "tests", "description": "Test suite", "keywords": ["test", "spec", "e2e", "integration"]},
            {"name": "infra", "description": "Infrastructure and deployment", "keywords": ["deploy", "ci", "docker", "config", "infra"]},
        ],
    },
    "rust": {
        "validation": {
    ...
    "go": {
        ...
        "modules": [
            ...
            {"name": "api", "description": "API handlers and middleware", "keywords": ["api", "handler", "route", "middleware"]},
    ...
    "generic": {
        ...
        "modules": [
            ...
            {"name": "config", "description": "Configuration and deployment", "keywords": ["config", "deploy", "ci", "docker"]},
        ],
    },
}
